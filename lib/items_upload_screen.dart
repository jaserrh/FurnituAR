...
import 'package:furniture_app/api_consumer.dart';
...
class _ItemsUploadScreenState extends State<ItemsUploadScreen> {
  ...
  TextEditingController itemPriceTextEditingController =
      TextEditingController();
  TextEditingController userLocationTextEditingController =
      TextEditingController();
        ...
        children: [
          ...
          ListTile(
            ...
            title: SizedBox(
              ...
              child: TextField(
                style: const TextStyle(color: Colors.black),
                controller: userLocationTextEditingController,
                decoration: const InputDecoration(
                  hintText: "Seller location",
                  hintStyle: TextStyle(color: Colors.black),
                  border: InputBorder.none,
                ),
              ),
  ...
  validateUploadFormAndUploadItemInfo() async {
    if (imageFileUint8List != null) {
      if (sellerNameTextEditingController.text.isNotEmpty &&
          ...
          userLocationTextEditingController.text.isNotEmpty &&
  ...
  saveItemInfoToFirestore() {
    ...
    FirebaseFirestore.instance.collection("items").doc(itemUniqueId).set({
      ...
      "userLocation": userLocationTextEditingController.text,
